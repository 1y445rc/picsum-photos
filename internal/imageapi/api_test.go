...
func TestAPI(t *testing.T) {
	...
	mockStorageImageProcessor, _ := vipsProcessor.New(ctx, log, image.NewCache(memoryCache.New(), &mockStorage.Provider{}), 3, 10)
...
func setup(t *testing.T, ctx context.Context) (*logger.Logger, image.Processor, *hmac.HMAC) {
	...
	imageProcessor, _ := vipsProcessor.New(ctx, log, imageCache, 3, 10)
